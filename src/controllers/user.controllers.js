// step 13: Register the user. Step 14 on user.routes.js
...
const registerUser = asyncHandler(async (req, res) => {
  // step 18: get the user info with logic. Step 19 on user.routes.js 9 line
  // get the user details form frontend, I mean postman
  ...
  console.log("check the files", req.files);
...
const loginUser = asyncHandler(async (req, res) => {
  // get data from frontend from req.body
